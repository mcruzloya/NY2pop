...
a.suf.chains <- readRDS("jagsout_a_suffolk_sp.RDS")
a.alb.chains <- readRDS("jagsout_a_albany_sp.RDS")
...
# Lifespan
lf.suf.chains <- readRDS("jagsout_lf_suffolk_sp.RDS")
lf.alb.chains <- readRDS("jagsout_lf_albany_sp.RDS")
...
ER.suf.chains <- readRDS("jagsout_epr_suffolk_sp.RDS")
ER.alb.chains <- readRDS("jagsout_epr_albany_sp.RDS")
...
pO.suf.chains <- readRDS("jagsout_pO_suffolk_sp.RDS")
pO.alb.chains <- readRDS("jagsout_pO_albany_sp.RDS")
...
# Larval survival
pLA.suf.chains <- readRDS("jagsout_pLA_suffolk_sp.RDS")
pLA.alb.chains <- readRDS("jagsout_pLA_albany_sp.RDS")
...
MDR.suf.chains <- readRDS("jagsout_MDR_suffolk_sp.RDS")
MDR.alb.chains <- readRDS("jagsout_MDR_albany_sp.RDS")
...
saveRDS(R0.suf.curves, file="R0_chains_suffolk_sp.RDS")
saveRDS(R0.alb.curves, file="R0_chains_albany_sp.RDS")
