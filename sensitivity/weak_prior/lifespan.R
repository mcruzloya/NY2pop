...
suffolk.out <- jags(data=jag.data, inits=inits, parameters.to.save=parameters, 
                    model.file="linear_lf_wp.txt", n.thin=nt, n.chains=nc, 
...
saveRDS(albany.out, file="jagsout_lf_albany_wp.RDS")
saveRDS(suffolk.out, file="jagsout_lf_suffolk_wp.RDS")
