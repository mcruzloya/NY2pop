...
a.suf.chains <- readRDS("jagsout_a_suffolk_wp.RDS")
a.alb.chains <- readRDS("jagsout_a_albany_wp.RDS")
...
load("/Users/cruzloya/git/NY2pop/code/jagsout_bc_CpipWNV_inf.Rdata")
...
# Lifespan
lf.suf.chains <- readRDS("jagsout_lf_suffolk_wp.RDS")
lf.alb.chains <- readRDS("jagsout_lf_albany_wp.RDS")
...
load("/Users/cruzloya/git/NY2pop/code/jagsout_PDR_CpipWNV_inf.Rdata")
...
ER.suf.chains <- readRDS("jagsout_epr_suffolk_wp.RDS")
ER.alb.chains <- readRDS("jagsout_epr_albany_wp.RDS")
...
pO.suf.chains <- readRDS("jagsout_pO_suffolk_wp.RDS")
pO.alb.chains <- readRDS("jagsout_pO_albany_wp.RDS")
...
load("/Users/cruzloya/git/NY2pop/code/jagsout_EV_Cpip_inf.Rdata")
...
# Larval survival
pLA.suf.chains <- readRDS("jagsout_pLA_suffolk_wp.RDS")
pLA.alb.chains <- readRDS("jagsout_pLA_albany_wp.RDS")
...
MDR.suf.chains <- readRDS("jagsout_MDR_suffolk_wp.RDS")
MDR.alb.chains <- readRDS("jagsout_MDR_albany_wp.RDS")
...
print("Tmax")
print(mean(R0.suf.Tmax, na.rm=TRUE))
print(quantile(R0.suf.Tmax, c(0.025, 0.975), na.rm=TRUE))
...
saveRDS(R0.suf.curves, file="R0_chains_suffolk_wp.RDS")
saveRDS(R0.alb.curves, file="R0_chains_albany_wp.RDS")
